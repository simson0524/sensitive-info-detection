...
![ER Diagram](./assets/ERD260118.drawio.png)
...
│   │   ├── new_domain_annotation.py         # 신도메인 데이터 어노테이션 모듈(향후 generation에 합치기, 함수 호출을 상위 레이어가 아니라 동 레이어에서 하기 때문) ✅
